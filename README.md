# Connect Matrix: Decentralized Network Rewards Platform

Connect Matrix is an innovative blockchain-powered network rewards ecosystem designed to revolutionize collaborative value creation and incentive alignment across digital networks.
...
1. **Affiliate Network Contract (`affiliate-network.clar`)**
   - Manages network participant registration and status
   - Handles tier progression
   - Processes basic interactions and rewards
   - Tracks participant performance

2. **Network Offerings Contract (`network-offerings.clar`)**
   - Product/service listing and categorization
   - Campaign management
   - Bundle creation and management
   - Performance tracking

3. **Network Rankings Contract (`network-rankings.clar`)**
...
4. **Reward Distributor Contract (`reward-distributor.clar`)**
   ...
   - Split reward management
   - Comprehensive reward history tracking
